function Enable-AIFoundryPublicAccess {
    ...
    .EXAMPLE
    Enable-AIFoundryPublicAccess -ResourceGroupName rg-demo -AIFoundryName aif-demo-123

    .EXAMPLE
    Enable-AIFoundryPublicAccess -ResourceGroupName rg-demo -SqlServerName sql-demo-123
    ...
    begin {
        ...
        Write-Verbose "Starting Enable-AIFoundryPublicAccess process"
    ...
    process {
        ...
        Write-Verbose "Enable-AIFoundryPublicAccess process completed"
    }
}
