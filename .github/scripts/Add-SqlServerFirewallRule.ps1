function Add-SqlServerFirewallRule {
    ...
    .EXAMPLE
    Add-SqlServerFirewallRule -ResourceGroupName 'rg-test' -SqlServerName 'sql-test' -FirewallRuleName 'GitHubRunner-123'

    .EXAMPLE
    Add-SqlServerFirewallRule -ResourceGroupName 'rg-test' -SqlServerName 'sql-test' -FirewallRuleName 'GitHubRunner-123' -Force
    ...
    begin {
        ...
        Write-Verbose "Starting Add-SqlServerFirewallRule process"
    ...
    process {
        ...
        Write-Verbose "Add-SqlServerFirewallRule process completed"
    }
}

# Call the function with script parameters when run as script
if ($MyInvocation.InvocationName -ne '.') {
    Add-SqlServerFirewallRule @PSBoundParameters
}