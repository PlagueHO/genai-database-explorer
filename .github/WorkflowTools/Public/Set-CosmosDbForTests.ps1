<#
    ...
    .EXAMPLE
    Set-CosmosDbForTests.ps1 -ResourceGroupName 'rg-test'

    .EXAMPLE
    Set-CosmosDbForTests.ps1 -ResourceGroupName 'rg-test' -DatabaseName 'TestDB' -ModelsContainer 'TestModels'
...
function Set-CosmosDbForTests {
    ...
    begin {
        ...
        Write-Verbose "Starting Cosmos DB configuration for tests"
    ...
    process {
        ...
        Write-Verbose "Cosmos DB configuration for tests completed"
    }
}
