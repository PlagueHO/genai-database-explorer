// Contract: IPromptTemplateParser
// Location: src/GenAIDBExplorer/GenAIDBExplorer.Core/PromptTemplates/IPromptTemplateParser.cs
// Purpose: Parses .prompt files (YAML frontmatter + role-delimited messages).
