...
) : ISemanticModelProvider
{
    ...
    private static readonly ResourceManager _resourceManagerLogMessages = new("GenAIDBExplorer.Core.Resources.LogMessages", typeof(SqlSemanticModelProvider).Assembly);
