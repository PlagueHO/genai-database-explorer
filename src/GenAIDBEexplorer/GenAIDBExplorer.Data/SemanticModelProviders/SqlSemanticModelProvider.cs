...
internal sealed class SqlSemanticModelProvider : ISemanticModelProvider
{
    ...
    public async IAsyncEnumerable<SemanticModelTable> QueryTablesAsync()
    {
        var columnMap = new Dictionary<string, LinkedList<SemanticModelColumn>>(StringComparer.InvariantCultureIgnoreCase);
    ...
    public async Task<Dictionary<string, (string table, string column)>> QueryReferencesAsync()
    {
    ...
    public async Task<Dictionary<string, string?>> QueryTableDescriptionsAsync()
    {
    ...
    //    /// <summary>
    //    /// Formats the provided parts into a single string, joined by the invariant culture's number decimal separator.
    //    /// </summary>
    //    /// <param name="parts">An array of strings to be formatted and joined.</param>
    //    /// <returns>A single string with the parts joined by the invariant culture's number decimal separator.</returns>
    //    /// <example>
    //    /// <code>
    //    /// string formattedName = SqlSchemaProvider.FormatName("schema", "table", "column");
    //    /// // formattedName will be "schema.table.column" if the invariant culture's number decimal separator is "."
    //    /// </code>
    //    /// </example>
